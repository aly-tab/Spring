package com.wp.languages.controllers;
...
import com.wp.languages.services.LanguageService;
@RestController
public class LanguagesApi {
    ...
    public Language update(@PathVariable("id") Long id, @RequestParam(value="name") String name, @RequestParam(value="creator") String creator, @RequestParam(value="currentVersion") String lang, @RequestParam(value="pages") Integer currentVersion) {
